...
async def main():
    ...
    async with engine.begin() as conn:
        ...
        await conn.execute(text("INSERT INTO rbac_role_permissions (id, role_id, permission_id, created_at, updated_at, version_id) VALUES (:id, :r_id, :p_id, now(), now(), 1) ON CONFLICT DO NOTHING"), {
            "id": str(uuid.uuid4()),
            "r_id": hr_role_id,
            "p_id": perm_id
        })
