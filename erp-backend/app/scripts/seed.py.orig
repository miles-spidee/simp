...
def seed_rbac_data(session: Session, state: dict[str, list[Any]]):
    roles = seed_rows(session, "rbac_roles", [
        ...
        {"name": "Admin", "code": "ADMIN", "description": "Administrator with broad access", "is_system": True},
        {"name": "Mentor", "code": "MENTOR", "description": "Internship mentor", "is_system": True},
        {"name": "Student", "code": "STUDENT", "description": "Student user", "is_system": True},
        {"name": "Employee", "code": "EMPLOYEE", "description": "Internal employee", "is_system": True},
        {"name": "Faculty", "code": "FACULTY", "description": "Academic faculty", "is_system": True},
        {"name": "HR", "code": "HR", "description": "Human resources user", "is_system": True},
        {"name": "Recruiter", "code": "RECRUITER", "description": "Company recruiter", "is_system": True},
        {"name": "Department Coordinator", "code": "DEPT_COORDINATOR", "description": "Department coordinator", "is_system": True},
        {"name": "Organization Coordinator", "code": "ORG_COORDINATOR", "description": "Organization coordinator", "is_system": True},
    ], state)
    ...
    permission_rows = []
    for index, feature_obj in enumerate(features):
        action_obj = pick(actions, index)
        permission_rows.append({
            "feature_id": feature_obj.id,
            "action_id": action_obj.id,
            "name": f"{feature_obj.name} {action_obj.name}",
            "code": f"{feature_obj.code}_{action_obj.code}",
