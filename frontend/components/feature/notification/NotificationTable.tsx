              ...
              >
                <td className="px-6 py-4">
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs text-text-secondary truncate max-w-[250px]">{n.message}</span>
                  </div>
                </td>
                <td className="px-6 py-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col">
                      <span className="font-medium text-text-primary">{n.channel}</span>
                      <span className="text-xs text-text-secondary">{n.module}</span>
                    </div>
                  </div>
                </td>
                <td className="px-6 py-4">
                  <div className="flex flex-col">
                    <span className="font-medium text-text-primary">{n.recipient}</span>
                    <span className="text-xs text-text-secondary">{n.role}</span>
                  </div>
                </td>
                <td className="px-6 py-4">
