              ...
              <div className="space-y-6 animate-slide-in">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  {[
                    ...
                    <div 
                      key={idx} 
                      className={`bg-white border border-slate-200 rounded-xl/80 rounded-xl p-5 hover:border-blue-500/40 hover:-translate-y-1 hover:shadow-md hover:shadow-blue-500/5 transition-all duration-300 ease-out cursor-pointer ${stat.color}`}
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    {/* Latest notices */}
                    <div className="bg-white border border-slate-200 rounded-xl/80 rounded-xl p-6 space-y-4 shadow-sm hover:shadow-md hover:border-blue-500/20 transition-all duration-300">
                    ...
                    {/* Capstone snippet */}
                    <div className="bg-white border border-slate-200 rounded-xl/80 rounded-xl p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 shadow-sm hover:shadow-md hover:-translate-y-0.5 hover:border-blue-500/30 transition-all duration-300">
                      ...
                      <button
                        ...
                        className="w-full sm:w-auto px-4 py-2 border border-slate-200 hover:border-blue-600 hover:bg-blue-50 text-xs font-bold text-slate-700 hover:text-blue-600 transition-colors shadow-sm"
                      >
                        Open Workspace
                      </button>
                    </div>
                    ...
                    <div className="bg-white border border-slate-200 rounded-xl/80 rounded-xl p-6 space-y-4 shadow-sm hover:shadow-md hover:border-blue-500/30 transition-all duration-300">
