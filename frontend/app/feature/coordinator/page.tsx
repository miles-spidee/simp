                ...
                <tbody className="divide-y divide-border">
                  {filteredCoordinators.map(c => (
                    <tr key={c.id} className="hover:bg-blue-50/50 cursor-pointer transition-colors" onClick={() => handleCoordinatorClick(c)}>
                      ...
                      <td className="px-6 py-4 text-text-secondary">{c.collegeId}</td>
                      <td className="px-6 py-4 text-text-secondary">{c.assignedStudentsCount}</td>
                      <td className="px-6 py-4 text-text-secondary">{c.activeBatchesCount}</td>
                      <td className="px-6 py-4 text-text-secondary">{c.placementsCount}</td>
