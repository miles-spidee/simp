export interface Opportunity {
  ...
  postedDate: string;
  type?: string;
  internshipType?: 'industrial' | 'corporate' | 'research' | 'free' | 'stipend' | 'paid';
  amount?: string;
  value?: string;
  description?: string;
  duration?: string;
