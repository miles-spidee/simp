...
class AppColors {
  // Primary Colors (Mapped to Pinesphere Design System)
  static const Color primary = Color(0xFF004AC6); // Primary Blue
  static const Color primaryDark = Color(0xFF003EA6); // Dark Blue
  static const Color secondary = Color(0xFF7C3AED);

  // Pinesphere Specific Design System Colors
  ...
  // Background Colors (for backwards compatibility)
  ...
  static const Color surfaceLight2 = Color(0xFFE5EEFF);
  static const Color surfaceLight3 = Color(0xFFDBE1FF);
